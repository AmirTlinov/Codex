...
| `assistant_language`                             | string                                                            | Force user-facing assistant prose (incl. reasoning shown in the UI and reasoning summaries) to this language; keep code/paths/commands in English. `"auto"` disables. |
