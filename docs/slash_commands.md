...
| `/context-debug` | show what context is sent to the model (workbench diagnostics)            |
| `/mcp`          | list configured MCP tools                                                  |
| `/experimental` | open the experimental menu to enable beta and experimental features        |
