...
14. `--focus` управляет уровнем шума в текстовом выводе: `auto` (по умолчанию) подсвечивает
...
15. Появились готовые навигационные сценарии `codex navigator flow <name>`: например,
