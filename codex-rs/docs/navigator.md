...
15. `--focus` управляет уровнем шума в текстовом выводе: `auto` (по умолчанию) подсвечивает
...
16. Появились готовые навигационные сценарии `codex navigator flow <name>`: например,
...
17. Для оценки ранжирования есть `codex navigator eval suite.json`: описываете кейсы в JSON
