...
fn parse_tree(source: &str) -> Result<tree_sitter::Tree, String> {
    parse_with_cached_parser(&PARSER, "typescript", source)
}
...
pub struct TypeScriptSymbolLocator;

impl TypeScriptSymbolLocator {
    pub fn instance() -> &'static dyn SymbolLocator {
        static INSTANCE: TypeScriptSymbolLocator = TypeScriptSymbolLocator;
        &INSTANCE
    }
}

impl SymbolLocator for TypeScriptSymbolLocator {
