...
pub enum Feature {
    ...
    GuardianApproval,
    /// Enable an internal reflective sidecar that maintains a bounded
    /// session-local reflective window for future turns.
    ReflectiveWindow,
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        id: Feature::ReflectiveWindow,
        key: "reflective_window",
        stage: Stage::UnderDevelopment,
        default_enabled: false,
    },
    FeatureSpec {
